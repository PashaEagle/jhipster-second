package com.second.web.rest;

import com.second.config.KafkaProperties;
...
class JhipsterSecondKafkaResourceIT {
    ...
    void setup() {
        ...
        JhipsterSecondKafkaResource kafkaResource = new JhipsterSecondKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc.perform(post("/api/jhipster-second-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc.perform(get("/api/jhipster-second-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
