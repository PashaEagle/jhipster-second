...
@RestController
@RequestMapping("/api/jhipster-second-kafka")
public class JhipsterSecondKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhipsterSecondKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhipsterSecondKafkaResource(KafkaProperties kafkaProperties) {
